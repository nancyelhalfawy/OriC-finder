...
this["JST"]["skewanalyze.layout"] = Handlebars.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  return "<div id='graph-placeholder' width='640' height='480' style='width: 640px; height: 480px;'></div>\n<div id='synthesized-dna-graph-buffer' width='640' height='480' style='width: 640px; height: 480px;'></div>\n";
  },"useData":true});
