 ...
 * see: http://github.com/jrburke/amd_require-cs for details
 */

/*jslint */
/*global amd_define, window, XMLHttpRequest, importScripts, Packages, java,
  ActiveXObject, process, amd_require */
/**
*
...
amd_define(['coffee-script'], function (CoffeeScript) {
    'use strict';
    var fs, getXhr,
    ...
    return {
        ...
        load: function (name, parentRequire, load, config) {
            ...
            // amd_requirejs binding.
            var fullName = CoffeeScript.helpers.isCoffee(name) ? name : name + '.coffee';
            var path = parentRequire.toUrl(fullName);
            fetchText(path, function (text) {
                // preserve existing logic. integrate new 'literate' compile flag with any amd_requirejs configs.
